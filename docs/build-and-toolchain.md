...
| `zig build -Darch=riscv64 smoke-riscv` | riscv64 M7+SK-34：shared probes + tmpfs/random boot + virtio + U-mode |
| `zig build -Darch=aarch64 smoke-aarch64` | aarch64 M9-7+SK-34：shared probes + tmpfs/random boot + default timer + EL0/SVC |
