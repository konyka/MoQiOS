...
| `zig build -Darch=riscv64 smoke-riscv` | riscv64 M7+SK-39：shared probes + slim footprint/env/fd + virtio + U-mode |
| `zig build -Darch=aarch64 smoke-aarch64` | aarch64 M9-7+SK-39：shared probes + slim footprint/env/fd + default timer + EL0/SVC |
