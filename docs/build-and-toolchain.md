...
| `zig build -Darch=riscv64 smoke-riscv` | riscv64 M7+SK-7：serial facade + 统一 pmm + virtio + U-mode + sched |
| `zig build -Darch=aarch64 smoke-aarch64` | aarch64 M9-7+SK-7：serial facade + 统一 pmm + preempt + `M9-7 complete` |
