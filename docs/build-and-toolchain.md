...
| `zig build -Darch=riscv64 smoke-riscv` | riscv64 M7+SK-30：timeslice native-user + virtio + U-mode |
| `zig build -Darch=aarch64 smoke-aarch64` | aarch64 M9-7+SK-30：timeslice native-user + EL0/SVC |
