...
| `zig build -Darch=riscv64 smoke-riscv` | riscv64 M7+SK-40：shared probes + slim BSS + portable copy_from_user + virtio + U-mode |
| `zig build -Darch=aarch64 smoke-aarch64` | aarch64 M9-7+SK-40：shared probes + slim BSS + portable copy_from_user + default timer + EL0/SVC |
