...
| `zig build -Darch=riscv64 smoke-riscv` | riscv64 M7+SK-37：shared probes + slim footprint + virtio + U-mode |
| `zig build -Darch=aarch64 smoke-aarch64` | aarch64 M9-7+SK-37：shared probes + slim footprint + default timer + EL0/SVC |
