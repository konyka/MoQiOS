...
> Last update: 2026-07-24 (SK-140 ACE in AE|CWR|ECE + prior SK-139 reviewed and verified)
...
| `zig build smoke-smp` | Passed | Same markers with `MOQI_SMP=2`. |
| `zig build -Darch=riscv64 smoke-riscv` | Passed | Includes `[SK-140] tcp ace ae|cwr|ece non-x86: OK`. |
| `zig build -Darch=aarch64 smoke-aarch64` | Passed | Includes `[SK-140] tcp ace ae|cwr|ece non-x86: OK`. |
