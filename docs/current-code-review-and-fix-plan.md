...
> Last update: 2026-07-22 (SK-78 TCP sockaddr_in6 bind/connect/accept + prior SK-77 reviewed and verified)
...
| `zig build smoke-smp` | Passed | Same markers with `MOQI_SMP=2`. |
| `zig build -Darch=riscv64 smoke-riscv` | Passed | Includes `[SK-78] tcp sockaddr_in6 connect name non-x86: OK`. |
| `zig build -Darch=aarch64 smoke-aarch64` | Passed | Includes `[SK-78] tcp sockaddr_in6 connect name non-x86: OK`. |
