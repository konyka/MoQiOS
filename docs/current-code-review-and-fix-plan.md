...
> Last update: 2026-07-23 (SK-109 keepalive SND.UNA-1 + prior SK-108 reviewed and verified)
...
| `zig build smoke-smp` | Passed | Same markers with `MOQI_SMP=2`. |
| `zig build -Darch=riscv64 smoke-riscv` | Passed | Includes `[SK-109] tcp keepalive snd.una-1 non-x86: OK`. |
| `zig build -Darch=aarch64 smoke-aarch64` | Passed | Includes `[SK-109] tcp keepalive snd.una-1 non-x86: OK`. |
