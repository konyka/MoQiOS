...
> Last update: 2026-07-24 (SK-134 ACE counters + prior SK-133 reviewed and verified)
...
| `zig build smoke-smp` | Passed | Same markers with `MOQI_SMP=2`. |
| `zig build -Darch=riscv64 smoke-riscv` | Passed | Includes `[SK-134] tcp ace counters non-x86: OK`. |
| `zig build -Darch=aarch64 smoke-aarch64` | Passed | Includes `[SK-134] tcp ace counters non-x86: OK`. |
