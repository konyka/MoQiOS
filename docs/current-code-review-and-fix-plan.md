...
> Last update: 2026-07-23 (SK-111 SACK pipe accounting + prior SK-110 reviewed and verified)
...
| `zig build smoke-smp` | Passed | Same markers with `MOQI_SMP=2`. |
| `zig build -Darch=riscv64 smoke-riscv` | Passed | Includes `[SK-111] tcp sack pipe accounting non-x86: OK`. |
| `zig build -Darch=aarch64 smoke-aarch64` | Passed | Includes `[SK-111] tcp sack pipe accounting non-x86: OK`. |
