...
> Last update: 2026-07-23 (SK-101 IPv4 Path MTU + prior SK-100 reviewed and verified)
...
| `zig build smoke-smp` | Passed | Same markers with `MOQI_SMP=2`. |
| `zig build -Darch=riscv64 smoke-riscv` | Passed | Includes `[SK-101] ipv4 path mtu frag-needed non-x86: OK`. |
| `zig build -Darch=aarch64 smoke-aarch64` | Passed | Includes `[SK-101] ipv4 path mtu frag-needed non-x86: OK`. |
