...
> Last update: 2026-07-24 (SK-125 HyStart++ + prior SK-124 reviewed and verified)
...
| `zig build smoke-smp` | Passed | Same markers with `MOQI_SMP=2`. |
| `zig build -Darch=riscv64 smoke-riscv` | Passed | Includes `[SK-125] tcp hystart++ non-x86: OK`. |
| `zig build -Darch=aarch64 smoke-aarch64` | Passed | Includes `[SK-125] tcp hystart++ non-x86: OK`. |
