...
> Last update: 2026-07-23 (SK-98 TCP IPv6 MSS/PMTU + prior SK-97 reviewed and verified)
...
| `zig build smoke-smp` | Passed | Same markers with `MOQI_SMP=2`. |
| `zig build -Darch=riscv64 smoke-riscv` | Passed | Includes `[SK-98] tcp ipv6 mss pmtu non-x86: OK`. |
| `zig build -Darch=aarch64 smoke-aarch64` | Passed | Includes `[SK-98] tcp ipv6 mss pmtu non-x86: OK`. |
