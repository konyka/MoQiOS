...
export ZIG_LOCAL_CACHE=${MOQI_TEST_CACHE:-/tmp/moqi-libc-test-cache}
export ZIG_GLOBAL_CACHE=${MOQI_TEST_GCACHE:-/tmp/moqi-libc-test-gcache}
...
fail=0
for t in test_string test_format test_malloc; do
    echo "== $t =="
