...
pub const inotify_policy = @import("fs/inotify_policy.zig");
pub const eventfd_policy = @import("fs/eventfd_policy.zig");
pub const getdents_policy = @import("fs/getdents_policy.zig");
pub const readlink_policy = @import("fs/readlink_policy.zig");
pub const chdir_policy = @import("fs/chdir_policy.zig");
pub const splice = @import("fs/splice.zig");
...
pub const mmap_policy = @import("mm/mmap_policy.zig");
pub const shared_mapping_policy = @import("mm/shared_mapping_policy.zig");
...
pub const capability_generation_policy = @import("ipc/capability_generation_policy.zig");
pub const ipc_authority = @import("ipc/ipc_authority.zig");
pub const capability_lifecycle_policy = @import("ipc/capability_lifecycle_policy.zig");
pub const socket_policy = @import("net/socket_policy.zig");
pub const socket_address_policy = @import("net/socket_address_policy.zig");
pub const ipc_call_reply_policy = @import("ipc/ipc_call_reply_policy.zig");
pub const time_set_policy = @import("proc/time_set_policy.zig");
pub const swap_policy = @import("mm/swap_policy.zig");
pub const shm_policy = @import("ipc/shm_policy.zig");
pub const sysv_shm_policy = @import("ipc/sysv_shm_policy.zig");
pub const posix_mq_attr_policy = @import("ipc/posix_mq_attr_policy.zig");
pub const sysv_shm_lifecycle_policy = @import("ipc/sysv_shm_lifecycle_policy.zig");
pub const posix_timer_policy = @import("ipc/posix_timer_policy.zig");
...
pub const clone3_policy = @import("proc/clone3_policy.zig");
pub const close_range_policy = @import("proc/close_range_policy.zig");
pub const move_pages_policy = @import("proc/move_pages_policy.zig");
pub const epoll_policy = @import("net/epoll_policy.zig");
pub const accept4_policy = @import("net/accept4_policy.zig");
...
pub const sysv_policy = @import("ipc/sysv_policy.zig");
pub const time_policy = @import("ipc/time_policy.zig");
pub const time_syscall = @import("proc/time_syscall.zig");
pub const sigreturn_policy = @import("proc/sigreturn_policy.zig");
...
pub const moqi_syscalls_header = @embedFile("../lib/moqi_libc/include/moqi_syscalls.h");
