//! Minimal Flattened Device Tree (FDT/DTB) walker for early riscv64 bring-up.
//!
//! Milestone 3 only needs `/memory` `reg` regions. Parent `#address-cells` /
...
pub fn findMemoryRegions(dtb: usize, out: []MemRegion) usize {
    ...
    var addr_stack: [16]u32 = .{2} ** 16;
    var size_stack: [16]u32 = .{1} ** 16;
    var depth: usize = 0;
    var count: usize = 0;
    var in_memory = false;
    var p = struct_base;
