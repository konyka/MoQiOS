/// Classic VGA 8x16 bitmap font, printable ASCII 32-127 (96 glyphs x 16 bytes).
///
/// Bitmap data: XFree86 vga.bdf font, via ReactOS FreeLoader
/// (boot/freeldr/freeldr/arch/vgafont.c, GPL-2.0-or-later; MoQiOS is GPLv3).
/// Each glyph is 16 bytes, one per row, bit 7 = leftmost pixel.
pub const GLYPH_W: u32 = 8;
pub const GLYPH_H: u32 = 16;
pub const FIRST: u8 = 32;
pub const LAST: u8 = 127;

/// Glyph rows for ASCII 32..127 (127 is the DEL "blank box" glyph).
pub const data: [96][16]u8 = .{
